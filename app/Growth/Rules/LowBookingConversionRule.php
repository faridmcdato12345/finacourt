    ...
    public function evaluate(GrowthRecommendationContext $context): Collection
    {
        ...
        return $context->venueConversions()
            ...
            ->map(fn (array $venue) => new GrowthRecommendation(
                ...
                title: "{$venue['venue_name']} gets visits but few bookings",
                explanation: "This venue had {$venue['profile_views']} page visits from {$venue['unique_visitors']} different visitors and {$venue['bookings']} confirmed bookings in the last {$context->lookbackDays} days. That means about {$venue['conversion_rate']}% of visits became bookings.",
                evidence: [
                ...
                actionLabel: 'Improve your public page',
