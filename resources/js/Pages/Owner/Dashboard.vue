...
const metrics = () => [
    ...
    { label: 'Booked court value', value: money(props.marketplace.booking_revenue), detail: 'Confirmed bookings only', icon: 'wallet' },
