    ...
    <OwnerLayout>
        <div class="mx-auto max-w-[92rem] space-y-7">
            ...
            <section class="app-card overflow-hidden">
                ...
                <div v-if="!demand.available" class="px-6 py-12 text-center"><h4 class="font-semibold text-slate-900">Publish a venue to see nearby searches</h4><p class="mx-auto mt-2 max-w-xl text-sm leading-6 text-slate-500">FinACourt can show nearby searches after you have a published venue with at least one active court.</p></div>
                <div v-else-if="demand.privacy.suppressed" class="px-6 py-12 text-center"><h4 class="font-semibold text-slate-900">Not enough nearby searches yet</h4><p class="mx-auto mt-2 max-w-xl text-sm leading-6 text-slate-500">To protect players, this appears only after at least {{ demand.privacy.minimum_unique_searchers }} different anonymous searchers are in this place and date range.</p></div>
                <div v-else class="space-y-6 p-5 sm:p-6">
                    <div class="grid gap-3 sm:grid-cols-2 xl:grid-cols-4">
                        <div v-for="metric in [
                            ...
                            ['Different searchers', demand.metrics.unique_searchers, trend(demand.comparison.unique_searchers_percent)],
            ...
            <div class="grid gap-4 sm:grid-cols-3">
                <section v-for="metric in [
                    ...
                    ['QR & referral bookings', report.acquisition_metrics.qr_referral_bookings, money(report.acquisition_metrics.qr_referral_revenue), 'Bookings from your QR codes and referral links'],
