        ...
        <div class="mx-auto max-w-[92rem] space-y-7">
            ...
            <div class="grid gap-4 sm:grid-cols-2 xl:grid-cols-4">
                <section v-for="metric in [
                    ...
                    ['Google bookings', report.acquisition_metrics.google_bookings, money(report.acquisition_metrics.google_revenue), 'Google Search, Maps, and Ads combined'],
                    ['QR bookings', report.acquisition_metrics.qr_bookings, money(report.acquisition_metrics.qr_revenue), 'Bookings that started from your QR codes'],
                    ['Shared-link bookings', report.acquisition_metrics.shared_link_bookings, money(report.acquisition_metrics.shared_link_revenue), 'Bookings from a tracked copied or player-shared link'],
