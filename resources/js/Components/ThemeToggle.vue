...
onMounted(() => applyTheme(document.documentElement.dataset.theme));
</script>

<template>
    <button type="button" data-theme-toggle class="theme-toggle" aria-label="Switch color theme" aria-pressed="false" title="Switch color theme">
