...
function statusDescription(status) {
    return {
        ...
        scheduled: 'Players can see it during its eligible dates and court times.',
        active: 'Make it visible now wherever its dates and court times are eligible.',
