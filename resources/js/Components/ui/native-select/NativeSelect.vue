    ...
    <select
      ...
      :class="
        cn(
          ...
          'focus-visible:border-slate-950 focus-visible:ring-slate-950/50 focus-visible:ring-3 dark:focus-visible:border-slate-300 dark:focus-visible:ring-slate-300/50',
