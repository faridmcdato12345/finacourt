                ...
                <div class="mt-10 space-y-12 text-[0.95rem] leading-7 text-slate-600">
                    <section id="information-we-collect" class="scroll-mt-28">
                        ...
                        <div class="mt-4 space-y-4">
                            ...
                            <p><strong class="text-slate-900">Technical and activity information.</strong> We process IP address, browser and device information, essential session and security data, page visits, referral source, QR or campaign identifiers, standard campaign fields, hashed advertising click identifiers, searches, filter choices, booking steps, and error or audit logs. FinACourt does not keep the raw advertising click identifier in its booking-attribution record.</p>
                    ...
                    <section id="analytics-and-location" class="scroll-mt-28">
                        ...
                        <div class="mt-4 space-y-4">
                            <p>FinACourt uses cookies or similar browser storage for sign-in sessions, security protection, preferences, booking flow, anonymous session measurement, referral attribution, and PWA operation. Some storage is essential for secure sign-in and booking. An encrypted first-party attribution cookie may keep the earliest and latest identifiable visit for up to the configured attribution period so an ordinary session timeout does not erase the source before booking. Blocking essential storage may prevent sign-in or booking from working; blocking attribution storage may cause a visit to be reported as Direct or Unknown.</p>
