            ...
            <article class="min-w-0 rounded-3xl border border-slate-200 bg-white p-6 shadow-sm sm:p-10">
                ...
                <div class="mt-10 space-y-12 text-[0.95rem] leading-7 text-slate-600">
                    ...
                    <section id="payments" class="scroll-mt-28">
                        ...
                        <div class="mt-4 space-y-4">
                            <p>Before checkout, FinACourt shows the court price, eligible promotion, any online platform service fee, any payment-provider fee when passed on, and the total payable amount. The confirmed booking keeps a price snapshot so later price changes do not silently rewrite it.</p>
                            <p><strong class="text-slate-900">Pay at venue.</strong> The venue collects the court price directly. FinACourt does not add a transaction, processing, or platform service fee to this payment option and does not hold those funds. FinACourt may record the expected or owner-reported payment status.</p>
